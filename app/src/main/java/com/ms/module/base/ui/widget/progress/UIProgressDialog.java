package com.ms.module.base.ui.widget.progress;
...
import com.ms.module.base.ui.util.FindViewUtil;
import com.ms.module.base.ui.widget.BasisDialog;
...
public class UIProgressDialog extends BasisDialog<UIProgressDialog> {
    ...
    public static class WeBoBuilder extends ProgressBarBuilder<WeBoBuilder> {
        ...
        public WeBoBuilder(Context context) {
            ...
            setIndeterminateDrawable(R.drawable.com_ms_module_dialog_loading)
                    .setBackgroundResource(R.color.comMsModuleDialogcolorLoadingBgWei)
                    .setBackgroundRadiusResource(R.dimen.com_ms_dp_radius_loading)
                    .setMinWidth(dp2px(150))
                    .setMinHeight(dp2px(110))
                    .setTextColorResource(R.color.comMsModuleDialogcolorLoadingTextWeiBo);
        }
    ...
    private static abstract class Builder<T extends UIProgressDialog.Builder> extends BasisBuilder<T> implements ICreateContentView {
        ...
        public Builder(Context context) {
            ...
            setBackgroundResource(R.color.comMsModuleDialogcolorLoadingBg)
                    .setLoadingSize(dp2px(30))
                    .setTextColorResource(R.color.comMsModuleDialogcolorLoadingText)
